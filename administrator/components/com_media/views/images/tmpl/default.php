...
<!-- by BI - Lightgallery Button start -->				
				<div class="pull-left">
				<span style="padding-left: 20px;"><input type="text" id="gallerytitle" value="" placeholder="Gallery Title – no brackets!" /></span>
				<button class="btn btn-success button-save-selected" type="button" onclick="ImageManager.gallery();window.parent.jQuery('.modal.in').modal('hide');window.parent.jModalClose();" data-dismiss="modal"><?php /* echo JText::_('COM_MEDIA_INSERT') */ ?>Lightgallery</button>  <a class="hasTooltip" title="The above selected folder you can use as a Lightgallery in your article with one (first image) thumbnail and the entered title as caption. Repeate this step for multiple galleries in the same article." href="#" /><span class="icon-question-sign"></span></a>
				</div>
<!-- by BI - Lightgallery Button end -->				
