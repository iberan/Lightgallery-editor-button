...
// by BI - define gallerytitle field
			this.gallerytitle = doc.getElementById('gallerytitle');
		...
		*/
		...
		{
			var tag = '',
			gpath = this.folderlist.value,
			gtitle = this.gallerytitle.value;
// replace all kinds of brackets
			gtitle = gtitle.replace(/[{}()\[\]]/g," - ");				
			tag = '{lightgallery type=local path=images/' + gpath + ' previewWidth=150}' + gtitle + '{/lightgallery}';
