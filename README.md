...
Known issue: because of a "dirty hack" some core Joomla! files on, upgrading Joomla! you'll loose this function. You may rebuild it according to my comments signed "by BI" in scripts.
